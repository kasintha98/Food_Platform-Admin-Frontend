...
export const SalesSummeryByDishType = (props) => {
    ...
    <div>
      ...
      allReports.salesSummeryByDishType.length > 0 ? (
        <div>
          ...
          >
            <ExcelSheet
              data={allReports.salesSummeryByDishType}
              name="Sales Summery By Dish Type"
            >
              ...
              <ExcelColumn label="DISH TYPE" value="dishType" />
              <ExcelColumn label="TOTAL QTY" value="totalQty" />
              <ExcelColumn
                label="% OF TOTAL QTY"
                value="percentageOfTotalQty"
              />
            ...
            <Table sx={{ minWidth: 800 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <CusTableCell1 align="center">% OF TOTAL QTY</CusTableCell1>
                  <CusTableCell1 align="center">ORDER VALUE</CusTableCell1>
                </TableRow>
              </TableHead>
              <TableBody>
                {allReports.salesSummeryByDishType.map((row, index) => (
                  <TableRow key={index}>
