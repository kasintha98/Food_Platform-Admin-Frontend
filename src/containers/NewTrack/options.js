...
const ICON_OPTION_NAMES = ["defaultVehicleIcon", "defaultDestinationIcon"];
const ICON_OPTIONS = {
  defaultVehicleIcon: {
...
class Options {
   ...
   */
  constructor(options) {
    this.pollingIntervalMillis = isValidPollingInterval(
    ...
    this.showTakenRoutePolyline =
      options.showTakenRoutePolyline == null ||
...
class OptionsModal {
  ...
  async initModal_(optionsModalContainerElementId) {
    ...
    this.confirmButton = document.getElementById(
      "options-modal__confirm-button"
    );
    this.cancelButton = document.getElementById("options-modal__cancel-button");
    this.pollingIntervalMillisField = document.getElementById(
      "polling-interval-ms"
    );
    this.showAnticipatedRoutePolylineField = document.getElementById(
      "show-anticipated-route-polyline"
    );
    this.showTakenRoutePolylineField = document.getElementById(
      "show-taken-route-polyline"
    );
    this.vehicleIconField = document.getElementById("vehicle-icon-selector");
    this.destinationIconField = document.getElementById(
      "destination-icon-selector"
    );
    ...
    this.pollingIntervalMillisField.onchange = (e) => {
      ...
      if (isValidPollingInterval(newPollingIntervalMs)) {
        ...
        document
          .getElementById("polling-interval-ms__min-val")
          .classList.add("error");
      }
    };
  ...
  saveToHistory() {
    ...
    window.history.replaceState(null, null, optionsString);
  }
  ...
  setFieldSelections_() {
    // Polling interval
    this.pollingIntervalMillisField.value = isValidPollingInterval(
...
export class ShipmentTrackingOptionsModal extends OptionsModal {
  /**
   * @param {string} id
   */
  constructor(id) {
