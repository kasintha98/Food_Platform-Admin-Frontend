/*
 * Copyright 2022 window.Google LLC. All rights reserved.
 *
...
export function initializeJourneySharing() {
...
class ShipmentTrackingApp {
  ...
  start() {
    ...
    this.mapView = new window.google.maps.journeySharing.JourneySharingMapView(
      mapViewOptions
    );
